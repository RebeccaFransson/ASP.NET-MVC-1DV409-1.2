...
namespace rf222cz_1_2_aventyrliga_kontakter.Models.DataModels
{
    ...
    public partial class AWEntities : DbContext
    {
        ...
        public virtual ObjectResult<uspGetContacts_Result> uspGetContacts()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<uspGetContacts_Result>("uspGetContacts");
        }
    
        public virtual int uspGetContactsPageForContact(Nullable<int> contactId, Nullable<int> pageSize, ObjectParameter recordCount)
        {
            var contactIdParameter = contactId.HasValue ?
                new ObjectParameter("ContactId", contactId) :
                new ObjectParameter("ContactId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("uspGetContactsPageForContact", contactIdParameter, pageSizeParameter, recordCount);
        }
    
        public virtual int uspGetContactsPageWise(Nullable<int> pageIndex, Nullable<int> pageSize, ObjectParameter recordCount)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("uspGetContactsPageWise", pageIndexParameter, pageSizeParameter, recordCount);
        }
